...
get_header(); ?>
        ...
        <article>
            <div class="container clearfix">
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        <img src="img/logo-badge.png" alt="Bootstrap to WordPress" class="logo">
                    </div><!-- col -->
    ...
    <section id="boost-income">
        <div class="container">
            <div class="section-header">
                <img src="img/icon-boost.png" alt="Chart">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <p>It’s fun to learn challenging new skills. Code hobbyists can add dynamic websites to their arsenal of tools to play with — <strong>you can even sell WordPress themes and plugins for cash!</strong> The possibilities are truly endless.</p>
    ...
    <section id="course-features">
        <div class="container">
            <div class="section-header">
                <img src="img/icon-rocket.png" alt="Rocket">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    ...
                    <p class="lead">Hailing from North Of The Wall (Yellowknife, Canada), Brad made the trek to the Wet Coast (Vancouver, Canada) to educate and equip himself with the necessary skills to become a spearhead in his trade of solving problems on the web, crafting design solutions, and speaking in code.</p>
                    <p class="lead">Brad's determination and love for what he does has landed him in some pretty interesting places with some neat people. He's had the privilege of working with, and providing solutions for, numerous businesses, big & small, across the Americas.</p>
                    <p class="lead">Brad builds custom websites, and provides design solutions for a wide-array of clientele at his company, Brightside Studios. He regularly blogs about passive income, living your life to the fullest, and provides premium quality web design tutorials and courses for tens of thousands of amazing people desiring to master their craft.</p>
            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                    ...
                    <div class="row testimonial">
                        <div class="col-sm-4">
                            <img src="img/brennan.jpg" alt="Picture of Brennan">
                        </div><!-- end col -->
                        <div class="col-sm-8">
                            <blockquote>
                    ...
                    <div class="row testimonial">
                        <div class="col-sm-4">
                            <img src="img/ben.png" alt="Illustration of man with moustache">
                        </div><!-- end col -->
                        <div class="col-sm-8">
                            <blockquote>
                    ...
                    <div class="row testimonial">
                        <div class="col-sm-4">
                            <img src="img/aj.png" alt="Illustration of man with beard">
                        </div><!-- end col -->
                        <div class="col-sm-8">
                            <blockquote>
                    ...
                    <div class="row testimonial">
                        <div class="col-sm-4">
                            <img src="img/ernest.png" alt="Illustration of man with a goatee">
                        </div><!-- end col -->
                        <div class="col-sm-8">
                            <blockquote>
